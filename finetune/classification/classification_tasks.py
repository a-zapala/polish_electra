...
class AR(RegressionTask):
    ...
    def get_scorer(self):
        return classification_metrics.ARScorer()


class CBD(ClassificationTask):
    """CBD classification."""
...
class CDSCE(ClassificationTask):
    """CDSC-E classification."""

    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(CDSCE, self).__init__(
            config, "cdsc-e", tokenizer,
...
class CDSCR(RegressionTask):
    """CDSC-R regression."""

    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(CDSCR, self).__init__(config, "cdsc-r", tokenizer, 0.0, 5.0)
...
class NKJP(ClassificationTask):
    """NKJP-NER classification."""

    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(NKJP, self).__init__(
            config, "nkjp", tokenizer,
            ["placeName", "persName", "orgName", "geogName", "time", "noEntity"]
        )
...
class PolEmoIn(ClassificationTask):
    """POLEMO2.0-IN classification."""

    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(PolEmoIn, self).__init__(
            config, "polemo-in", tokenizer,
            ["__label__meta_zero", "__label__meta_minus_m",
...
class PolEmoOut(ClassificationTask):
    """POLEMO2.0-IN classification."""

    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(PolEmoOut, self).__init__(
            config, "polemo-out", tokenizer,
            ["__label__meta_zero", "__label__meta_minus_m",
             "__label__meta_amb", "__label__meta_plus_m"]
        )
